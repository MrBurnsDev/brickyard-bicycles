      ...
      <div className="container-site py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div className="space-y-4">
            <h3 className="font-[var(--font-display)] text-2xl uppercase tracking-wide text-primary-foreground">
              Brickyard Bicycles
            </h3>
          ...
          {/* Navigation */}
          <div className="space-y-4">
            <h4 className="font-[var(--font-display)] text-sm uppercase tracking-widest text-primary-foreground/60">
              Navigate
            </h4>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4 pt-2">
                ...
                {/* Google Maps - TODO: Replace with actual URL */}
                <a
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/20">
          <p className="text-sm text-primary-foreground/50 text-center">
            Brickyard Bicycles · Martha&apos;s Vineyard
          </p>
        </div>
      </div>
    </footer>
