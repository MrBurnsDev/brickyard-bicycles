    ...
    <footer className="bg-stone-900 text-stone-300">
      <div className="container-width px-4 md:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {/* Brand */}
          <div>
            <h2 className="text-xl font-semibold text-white mb-2">Brickyard Bicycles</h2>
            <p className="text-stone-400">Martha&apos;s Vineyard</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {navigation.map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-stone-400 hover:text-white transition-colors">
                    {item.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="mt-12 pt-8 border-t border-stone-700">
          <p className="text-sm text-stone-500 text-center">
            Brickyard Bicycles &middot; Martha&apos;s Vineyard
          </p>
        </div>
      </div>
    </footer>
